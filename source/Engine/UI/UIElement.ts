...
export class UIElement {
    ...
    setDisabled ( value:boolean ) {
        ...
        if( 'disabled' in this._core ) this._core['disabled'] = value;
        return this;
    }
    ...
    constructor ( element:HTMLElement|SVGSVGElement, className?:string, title?:string ) {
        this._core = element;
        this._core.className = className;
        if( this._core instanceof HTMLElement ) {
            if( title ) this._core.title = title;
        }
    }
    ...
    onMouseDown ( callback:Function ) { this._core.addEventListener( 'mousedown'    , callback.bind( this ), false ); return this; }
    onMouseUp   ( callback:Function ) { this._core.addEventListener( 'mouseup'      , callback.bind( this ), false ); return this; }
    ...
    onFocus     ( callback:Function ) { this._core.addEventListener( 'focus'        , callback.bind( this ), false ); return this; }
    onBlur      ( callback:Function ) { this._core.addEventListener( 'blur'         , callback.bind( this ), false ); return this; }
