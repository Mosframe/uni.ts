...
import { UITexture      }   from '../UI/UITexture';
 ...
 * @extends {UIPanel}
 */
export class MaterialEditor extends UIPanel {
    ...
    constructor ( tool:ITool ) {
        ...
        managerRow.add( new UIButton( 'Paste' ).setMarginLeft( '4px' ).onClick( () => {
            ...
            tool.execute( new SetMaterialCommand( currentObject, copiedMaterial ), 'Pasted Material: ' + materialClass.getValue() );
            refreshUI();
            update();
        ...
        let materialName = new UIInput().setWidth( '150px' ).setFontSize( '12px' ).onChange( () => {
            ...
            tool.execute( new SetMaterialValueCommand( tool.selected, 'name', materialName.getValue() ) );
        ...
        function update() {
            ...
            if ( material ) {
                ...
                if ( material.uuid !== undefined && material.uuid !== materialUUID.getValue() ) {
                    ...
                    tool.execute( new SetMaterialValueCommand( currentObject, 'uuid', materialUUID.getValue() ) );
                ...
                if ( material.color !== undefined && material.color.getHex() !== materialColor.getHexValue() ) {
                    ...
                    tool.execute( new SetMaterialColorCommand( currentObject, 'color', materialColor.getHexValue() ) );

                }

                if ( material.roughness !== undefined && Math.abs( material.roughness - materialRoughness.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'roughness', materialRoughness.getValue() ) );

                }

                if ( material.metalness !== undefined && Math.abs( material.metalness - materialMetalness.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'metalness', materialMetalness.getValue() ) );

                }

                if ( material.emissive !== undefined && material.emissive.getHex() !== materialEmissive.getHexValue() ) {

                    tool.execute( new SetMaterialColorCommand( currentObject, 'emissive', materialEmissive.getHexValue() ) );

                }

                if ( material.specular !== undefined && material.specular.getHex() !== materialSpecular.getHexValue() ) {

                    tool.execute( new SetMaterialColorCommand( currentObject, 'specular', materialSpecular.getHexValue() ) );

                }

                if ( material.shininess !== undefined && Math.abs( material.shininess - materialShininess.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'shininess', materialShininess.getValue() ) );

                }

                if ( material.clearCoat !== undefined && Math.abs( material.clearCoat - materialClearCoat.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'clearCoat', materialClearCoat.getValue() ) );

                }

                if ( material.clearCoatRoughness !== undefined && Math.abs( material.clearCoatRoughness - materialClearCoatRoughness.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'clearCoatRoughness', materialClearCoatRoughness.getValue() ) );
                ...
                if ( material.vertexColors !== undefined ) {
                    ...
                    if ( material.vertexColors !== vertexColors ) {
                        ...
                        tool.execute( new SetMaterialValueCommand( currentObject, 'vertexColors', vertexColors ) );
                ...
                if ( material.skinning !== undefined && material.skinning !== materialSkinning.getValue() ) {
                    ...
                    tool.execute( new SetMaterialValueCommand( currentObject, 'skinning', materialSkinning.getValue() ) );
                ...
                if ( material.map !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.map !== map ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'map', map ) );
                ...
                if ( material.alphaMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.alphaMap !== alphaMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'alphaMap', alphaMap ) );
                ...
                if ( material.bumpMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.bumpMap !== bumpMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'bumpMap', bumpMap ) );

                        }

                        if ( material.bumpScale !== materialBumpScale.getValue() ) {

                            tool.execute( new SetMaterialValueCommand( currentObject, 'bumpScale', materialBumpScale.getValue() ) );
                ...
                if ( material.normalMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.normalMap !== normalMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'normalMap', normalMap ) );
                ...
                if ( material.displacementMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.displacementMap !== displacementMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'displacementMap', displacementMap ) );

                        }

                        if ( material.displacementScale !== materialDisplacementScale.getValue() ) {

                            tool.execute( new SetMaterialValueCommand( currentObject, 'displacementScale', materialDisplacementScale.getValue() ) );
                ...
                if ( material.roughnessMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.roughnessMap !== roughnessMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'roughnessMap', roughnessMap ) );
                ...
                if ( material.metalnessMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.metalnessMap !== metalnessMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'metalnessMap', metalnessMap ) );
                ...
                if ( material.specularMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.specularMap !== specularMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'specularMap', specularMap ) );
                ...
                if ( material.envMap !== undefined ) {
                    ...
                    if ( material.envMap !== envMap ) {
                        ...
                        tool.execute( new SetMaterialMapCommand( currentObject, 'envMap', envMap ) );
                ...
                if ( material.reflectivity !== undefined ) {
                    ...
                    if ( material.reflectivity !== reflectivity ) {
                        ...
                        tool.execute( new SetMaterialValueCommand( currentObject, 'reflectivity', reflectivity ) );
                ...
                if ( material.lightMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.lightMap !== lightMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'lightMap', lightMap ) );
                ...
                if ( material.aoMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.aoMap !== aoMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'aoMap', aoMap ) );

                        }

                        if ( material.aoMapIntensity !== materialAOScale.getValue() ) {

                            tool.execute( new SetMaterialValueCommand( currentObject, 'aoMapIntensity', materialAOScale.getValue() ) );
                ...
                if ( material.emissiveMap !== undefined ) {
                    ...
                    if ( objectHasUvs ) {
                        ...
                        if ( material.emissiveMap !== emissiveMap ) {
                            ...
                            tool.execute( new SetMaterialMapCommand( currentObject, 'emissiveMap', emissiveMap ) );
                ...
                if ( material.side !== undefined ) {
                    ...
                    if ( material.side !== side ) {
                        ...
                        tool.execute( new SetMaterialValueCommand( currentObject, 'side', side ) );
                ...
                if ( material.blending !== undefined ) {
                    ...
                    if ( material.blending !== blending ) {
                        ...
                        tool.execute( new SetMaterialValueCommand( currentObject, 'blending', blending ) );
                ...
                if ( material.opacity !== undefined && Math.abs( material.opacity - materialOpacity.getValue() ) >= 0.01 ) {
                    ...
                    tool.execute( new SetMaterialValueCommand( currentObject, 'opacity', materialOpacity.getValue() ) );

                }

                if ( material.transparent !== undefined && material.transparent !== materialTransparent.getValue() ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'transparent', materialTransparent.getValue() ) );

                }

                if ( material.alphaTest !== undefined && Math.abs( material.alphaTest - materialAlphaTest.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'alphaTest', materialAlphaTest.getValue() ) );

                }

                if ( material.wireframe !== undefined && material.wireframe !== materialWireframe.getValue() ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'wireframe', materialWireframe.getValue() ) );

                }

                if ( material.wireframeLinewidth !== undefined && Math.abs( material.wireframeLinewidth - materialWireframeLinewidth.getValue() ) >= 0.01 ) {

                    tool.execute( new SetMaterialValueCommand( currentObject, 'wireframeLinewidth', materialWireframeLinewidth.getValue() ) );
